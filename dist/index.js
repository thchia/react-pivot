...
var _ = { without: __webpack_require__(202) };
...
var _ = { compact: __webpack_require__(183) };
var React = __webpack_require__(16);
...
var _ = { range: __webpack_require__(195) };
var React = __webpack_require__(16);
var partial = __webpack_require__(28);
...
var _ = {
  extend: __webpack_require__(186),
  each: __webpack_require__(185),
  sortBy: __webpack_require__(196),
  find: __webpack_require__(45)
}
...
var React = __webpack_require__(16);
var DataFrame = __webpack_require__(79);
...
module.exports = React.createClass({
  ...
  setDimensions: function setDimensions(updatedDimensions) {
  ...
  setHiddenColumns: function setHiddenColumns(hidden) {
    this.props.eventBus.emit('hiddenColumns', hidden);
    this.setState({ hiddenColumns: hidden });
    setTimeout(this.updateRows, 0);
  },

  setSort: function setSort(cTitle) {
  ...
  clearSolo: function clearSolo(title) {
...
var createRange = __webpack_require__(134);
